function Get-NcentralOrganizationUnits {
<#
.SYNOPSIS
Get a list of all N-Central Organization Units

.DESCRIPTION
This function gets a list of all N-Central Organization Units
...
.PARAMETER All
Optional. If specified, retrieves all Organization Units across all pages
...
.EXAMPLE
Get-NcentralOrganizationUnits -All

This example fetches all N-Central Organization Units
...
#>
    ...
    switch ($PsCmdlet.ParameterSetName) {
        'All' {
            $uri = "$script:BaseUrl/api/org-units?pageNumber=$PageNumber&pageSize=$PageSize"
            if ($PSBoundParameters.ContainsKey('SortOrder')) {
